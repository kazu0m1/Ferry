...
**[Download Ferry v1.1.2 for Windows (portable ZIP)](https://github.com/kazu0m1/Ferry/releases/latest/download/Ferry-v1.1.2-win-portable.zip)**
...
1. Download `Ferry-v1.1.2-win-portable.zip` using the **Download** link above.
...
├─ RELEASE_NOTES_v1.1.2.md       Current release notes
├─ CHANGELOG.md
├─ LICENSE.txt
├─ README.md
└─ README.ja.md
